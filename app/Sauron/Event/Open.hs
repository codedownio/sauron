...
getNodeUrl (SingleBranchWithInfoNode (EntityData {_static=branchInfo})) (findRepoBaseUrl -> Just repoBaseUrl) = Just (repoBaseUrl <> "/tree/" <> toString (branchWithInfoBranchName branchInfo))
